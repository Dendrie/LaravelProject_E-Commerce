...
<head>
    ...
    <title>Fa Style Checkout</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <style>
        body { background-color: #AFECEF; font-family: Arial, sans-serif; }
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="text-center flex-grow-1">
                <img src="{{ asset('images/log2.png') }}" alt="fa Style Logo" style="height:50px;">
                <h3 class="d-inline-block mb-0">fa Style | Checkout</h3>
            </div>
            <a href="profile">
        ...
        <div class="card-body">
            ...
            <form id="orderForm" action="{{ route('order.save') }}" method="post">
                ...
                <div class="btn-group btn-group-toggle d-flex justify-content-between" data-toggle="buttons">
                    <label class="btn btn-outline-primary flex-fill mr-2">
                ...
                <button type="submit" class="btn btn-info btn-block font-weight-bold" id="placeOrderBtn">Place Order</button>
            </form>
            @else
